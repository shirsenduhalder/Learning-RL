...
class StocksEnv(gym.Env):
    ...
    def __init__(self, prices, bars_count=DEFAULT_BARS_COUNT, commission=DEFAULT_COMMISION_PERC, reset_on_close=True, state_1d=False, random_ofs_on_reset=True, reward_on_close=False, volumes=False):
